# Symbols (MDL2-safe for FluentAvalonia.ttf)

> These are safe glyphs (E****) that exist in the bundled TTF
...
* `E****` → **safe (exists in your TTF)**
* `F8****` → **new Fluent icons → NOT in your font**
* Prefer E**** for consistency + reliability
