  ...
  ""languages"": [
    {
      ...
      ""convertFilenameContent"": ""Convert filename (Batch Mode)"",
      ""autoDetectCjkEncodingContent"": ""Auto-detect Legacy CJK Encoding for Plain Text (Batch Mode)"",
      ...
      ""hints"": {
        ...
        ""normalizeDialogQuotesHint"": ""Normalize dialog quote marks in source text and write result to destination text."",
        ""validateDialogQuotesHint"": ""Check current editor text for suspicious reversed dialog quote lines."",
        ...
        ""autoDetectCjkEncodingHint"": ""Automatically detect legacy Big5 and GB18030-family encodings for plain-text files during batch conversion and language detection."",
        ""extendUnicodeCompatHint"": ""Extend CJK text normalization to Unicode compatibility ideographs, Kangxi radicals, selected CJK radical forms, and known PDF extraction artifacts."",
        ""previewHint"": ""Preview selected file in Preview Box."",
        ""detectHint"": ""Detect Chinese variants (zho code) for files in List Box."",
        ""clearSourceListHint"": ""Clear all items in Source List Box."",
      ...
      ""themeModeSelectionContent"": [
        ""System"",
        ""Light"",
        ""Dark""
      ],
      ""saveTargetSelectionContent"": [
        ""Destination"",
        ""Source""
      ],
      ""uiSelectionContent"": [
      ...
      ""dictionaryGeneratorContents"": {
        ""tabTitle"": ""Dictionary"",
        ""pageTitle"": ""Dictionary Generation"",
        ""baseDirectoryLabel"": ""Base Dictionary Directory"",
        ""outputDirectoryLabel"": ""Output Directory"",
        ""customSlotsLabel"": ""Custom Dictionary Slots"",
        ""slotColumn"": ""Slot"",
        ""modeColumn"": ""Mode"",
        ""dictionaryFileColumn"": ""Dictionary file"",
        ""dictionaryFilePlaceholder"": ""Dictionary file path"",
        ""browseButton"": ""Browse"",
        ""removeButton"": ""Remove"",
        ""addCustomDictionaryButton"": ""Add Custom Dictionary"",
        ""applyCustomSlotsButton"": ""Apply to Current Converter"",
        ""applyCustomSlotsDuringStartupLabel"": ""Apply to Converter during startup"",
        ""generateZstdButton"": ""Generate ZSTD"",
        ""generateCborButton"": ""Generate CBOR"",
        ""generateJsonButton"": ""Generate JSON"",
        ""readableUnicodeJsonLabel"": ""Readable Unicode JSON"",
        ""baseDirectoryToolTip"": ""Directory containing the standard OpenccNet text dictionaries."",
        ""outputDirectoryToolTip"": ""Existing directory where the generated dictionary will be saved."",
        ""browseBaseDirectoryToolTip"": ""Select the base dictionary directory."",
        ""browseOutputDirectoryToolTip"": ""Select the output directory."",
        ""slotToolTip"": ""Select the dictionary slot to customize."",
        ""modeToolTip"": ""Append merges entries; Override replaces the selected slot."",
        ""dictionaryFileToolTip"": ""Path to a custom dictionary text file."",
        ...
        ""readableUnicodeJsonToolTip"": ""Write readable Unicode characters instead of escaped JSON sequences."",
        ""baseDirectoryPickerTitle"": ""Select Base Dictionary Directory"",
        ""outputDirectoryPickerTitle"": ""Select Output Directory"",
        ""customFilePickerTitle"": ""Select Custom Dictionary"",
        ""dictionaryTextFilesFilter"": ""Dictionary text files"",
        ...
        ""outputDirectoryNotFoundFormat"": ""Output directory not found: {0}"",
        ""unsupportedSlotFormat"": ""Custom dictionary row {0}: unsupported dictionary slot: {1}."",
        ""unsupportedModeFormat"": ""Custom dictionary row {0}: unsupported dictionary mode: {1}."",
        ""rowFileRequiredFormat"": ""Custom dictionary row {0}: file path is required."",
        ""rowFileNotFoundFormat"": ""Custom dictionary row {0}: file not found: {1}"",
        ""messageBoxTitle"": ""Dictionary Generation""
      },
      ""batchLogContents"": {
      ...
      ""runtimes"": {
        ...
        ""statuses"": {
          ...
          ""dialogQuoteValidationGoToFirstButton"": ""Go to first suspicious line"",
          ...
          ""dialogQuoteValidationHintMissingExtra"": ""The actual typo is often a missing, extra, reversed, or mixed dialog quote."",
    ...
    },
    {
      ...
      ""tabMessageContent"": ""日誌"",
      ""tabPreviewContent"": ""預覽"",
      ...
      ""btnPasteContent"": ""貼上"",
      ""btnCopyContent"": ""複製"",
      ""btnPreviewContent"": ""預覽"",
      ""btnDetectContent"": ""偵測"",
      ""btnOpenFileContent"": ""開啟檔案"",
      ""btnSaveAsContent"": ""儲存"",
      ...
      ""sourceContent"": ""來源："",
      ""destinationContent"": ""目標："",
      ""outputContent"": ""輸出："",
      ""filenameContent"": ""轉換檔名"",
      ""conversionSettingsContent"": ""轉換設定"",
      ""convertFilenameContent"": ""轉換檔名(批次轉換模式)"",
      ""autoDetectCjkEncodingContent"": ""自動偵測純文字的舊式 CJK 編碼（批次轉換模式）"",
      ""extendUnicodeCompatContent"": ""擴展 CJK 文字正規化的 Unicode 相容性"",
      ...
      ""hints"": {
        ...
        ""normalizeDialogQuotesHint"": ""正規化來源文字中的對話引號，並寫入目標文字框。"",
        ""validateDialogQuotesHint"": ""檢查目前編輯器文字中疑似反向的對話引號行。"",
        ...
        ""autoDetectCjkEncodingHint"": ""批次轉換及語言偵測純文字檔案時，自動偵測舊式 Big5 與 GB18030 系列編碼。"",
        ""extendUnicodeCompatHint"": ""擴展 CJK 文字正規化，包括 Unicode 相容漢字、康熙部首、部分 CJK 部首字形及已知的 PDF 文字擷取異常。"",
        ""previewHint"": ""在預覽框中預覽選取的檔案。"",
        ""detectHint"": ""偵測清單中檔案的中文變體（zho code）。"",
        ""clearSourceListHint"": ""清除來源清單中的所有項目。"",
      ...
      ""dictionaryGeneratorContents"": {
        ""tabTitle"": ""字典"",
        ""pageTitle"": ""字典產生"",
        ""baseDirectoryLabel"": ""基礎字典資料夾"",
        ""outputDirectoryLabel"": ""輸出資料夾"",
        ""customSlotsLabel"": ""自訂字典槽位"",
        ""slotColumn"": ""槽位"",
        ""modeColumn"": ""模式"",
        ""dictionaryFileColumn"": ""字典檔案"",
        ""dictionaryFilePlaceholder"": ""字典檔案路徑"",
        ""browseButton"": ""瀏覽"",
        ""removeButton"": ""移除"",
        ""addCustomDictionaryButton"": ""新增自訂字典"",
        ""applyCustomSlotsButton"": ""套用至目前轉換器"",
        ""applyCustomSlotsDuringStartupLabel"": ""啟動時套用至轉換器"",
        ""generateZstdButton"": ""產生 ZSTD"",
        ""generateCborButton"": ""產生 CBOR"",
        ""generateJsonButton"": ""產生 JSON"",
        ""readableUnicodeJsonLabel"": ""可讀 Unicode JSON"",
        ""baseDirectoryToolTip"": ""包含標準 OpenccNet 文字字典的資料夾。"",
        ""outputDirectoryToolTip"": ""用來儲存產生字典的現有資料夾。"",
        ""browseBaseDirectoryToolTip"": ""選擇基礎字典資料夾。"",
        ""browseOutputDirectoryToolTip"": ""選擇輸出資料夾。"",
        ""slotToolTip"": ""選擇要自訂的字典槽位。"",
        ""modeToolTip"": ""Append 會合併項目；Override 會取代所選槽位。"",
        ""dictionaryFileToolTip"": ""自訂字典文字檔的路徑。"",
        ...
        ""readableUnicodeJsonToolTip"": ""寫入可讀的 Unicode 字元，而非 JSON 跳脫序列。"",
        ""baseDirectoryPickerTitle"": ""選擇基礎字典資料夾"",
        ""outputDirectoryPickerTitle"": ""選擇輸出資料夾"",
        ""customFilePickerTitle"": ""選擇自訂字典"",
        ""dictionaryTextFilesFilter"": ""字典文字檔"",
        ""allFilesFilter"": ""所有檔案"",
        ...
        ""outputDirectoryNotFoundFormat"": ""找不到輸出資料夾：{0}"",
        ""unsupportedSlotFormat"": ""自訂字典第 {0} 列：不支援字典槽位 {1}。"",
        ""unsupportedModeFormat"": ""自訂字典第 {0} 列：不支援字典模式 {1}。"",
        ""rowFileRequiredFormat"": ""自訂字典第 {0} 列：必須指定檔案路徑。"",
        ""rowFileNotFoundFormat"": ""自訂字典第 {0} 列：找不到檔案：{1}"",
        ""messageBoxTitle"": ""字典產生""
      },
      ""batchLogContents"": {
        ...
        ""autoDetectCjkEncoding"": ""Auto-detect CJK Encoding (自動偵測 CJK 編碼)"",
      ...
      ""runtimes"": {
        ...
        ""statuses"": {
          ""statusBtnPasteEmpty"": ""剪貼簿是空的"",
          ""statusBtnPastePasted"": ""已貼上剪貼簿內容"",
          ""statusBtnCopyDestinationEmpty"": ""未複製：目標內容是空的。"",
          ""statusBtnCopyCopied"": ""文字已複製到剪貼簿"",
          ""statusBtnCopyClipboardError"": ""剪貼簿錯誤：{0}"",
          ""statusOpenFileError"": ""開啟檔案時發生錯誤：{0}"",
          ...
          ""statusDialogQuoteNormalizeEmpty"": ""沒有可正規化的對話引號內容"",
          ""statusDialogQuoteDestinationNotReady"": ""目標編輯器尚未就緒"",
          ""statusDialogQuoteNormalizeComplete"": ""對話引號正規化完成"",
          ""statusDialogQuoteValidationPassed"": ""對話引號驗證通過"",
          ""statusDialogQuoteValidationSuspiciousLines"": ""發現 {0} 行疑似對話引號問題"",
          ""dialogQuoteValidationTitle"": ""對話引號驗證"",
          ""dialogQuoteValidationWarningTitle"": ""驗證警告"",
          ""dialogQuoteValidationOkButton"": ""確定"",
          ""dialogQuoteValidationGoToFirstButton"": ""前往第一個疑似問題行"",
          ""dialogQuoteValidationCloseButton"": ""關閉"",
          ""dialogQuoteValidationNoIssues"": ""未發現疑似對話引號問題。"",
          ""dialogQuoteValidationFoundLines"": ""發現 {0} 行疑似對話引號問題。"",
          ""dialogQuoteValidationHintTitle"": ""提示："",
          ""dialogQuoteValidationHintMissingExtra"": ""實際錯字通常是缺少、多餘、顛倒或混用的對話引號。"",
          ""dialogQuoteValidationHintAbove"": ""可能出現在回報行或其前幾行。"",
          ""dialogQuoteValidationHintFixAgain"": ""修正來源文字後再驗證一次。"",
          ""dialogQuoteValidationMoreLines"": ""...以及其他 {0} 行。"",
          ...
          ""statusProcessCompleted"": ""轉換完成：{0} -> {1} ms"",
          ""statusBatchNothingToConvert"": ""沒有可轉換的內容。"",
          ""statusBatchDone"": ""批次轉換完成。（ {0} ）"",
          ""statusClearSource"": ""來源文字框已清除"",
          ""statusClearDestination"": ""目標內容已清除"",
          ""statusRemoveNothing"": ""沒有可移除的項目。"",
          ""statusRemoveItem"": ""項目（{0}）{1} 已移除"",
          ""statusPreviewNothing"": ""沒有可預覽的內容。"",
          ""statusPreviewFile"": ""檔案預覽：{0}"",
          ""statusPreviewReadError"": ""檔案讀取錯誤（{0}）"",
          ""statusDetectNothing"": ""沒有可偵測的內容。"",
          ""statusDetectDone"": ""批次 zho code 偵測完成。"",
          ""statusClearSourceList"": ""所有來源項目已清除。"",
          ""statusMessagesCleared"": ""訊息已清除。"",
          ""statusPreviewCleared"": ""預覽已清除。"",
    ...
    },
    {
      ...
      ""tabMessageContent"": ""日志"",
      ""tabPreviewContent"": ""预览"",
      ...
      ""btnPasteContent"": ""粘贴"",
      ""btnCopyContent"": ""复制"",
      ""btnPreviewContent"": ""预览"",
      ""btnDetectContent"": ""检测"",
      ""btnOpenFileContent"": ""打开文件"",
      ""btnSaveAsContent"": ""保存"",
      ...
      ""sourceContent"": ""来源："",
      ""destinationContent"": ""目标："",
      ""outputContent"": ""输出："",
      ""filenameContent"": ""转换文件名"",
      ""conversionSettingsContent"": ""转换设置"",
      ""convertFilenameContent"": ""转换文件名（批量转换模式）"",
      ""autoDetectCjkEncodingContent"": ""自动检测纯文本的旧式 CJK 编码（批量转换模式）"",
      ""extendUnicodeCompatContent"": ""扩展 CJK 文本规范化的 Unicode 兼容性"",
      ...
      ""hints"": {
        ...
        ""normalizeDialogQuotesHint"": ""规范化来源文本中的对话引号，并写入目标文本框。"",
        ""validateDialogQuotesHint"": ""检查当前编辑器文本中疑似反向的对话引号行。"",
        ...
        ""autoDetectCjkEncodingHint"": ""批量转换及语言检测纯文本文件时，自动检测旧式 Big5 和 GB18030 系列编码。"",
        ""extendUnicodeCompatHint"": ""扩展 CJK 文本规范化，包括 Unicode 兼容汉字、康熙部首、部分 CJK 部首字形及已知的 PDF 文本提取异常。"",
        ""previewHint"": ""在预览框中预览选中的文件。"",
        ""detectHint"": ""检测列表中文件的中文变体（zho code）。"",
        ""clearSourceListHint"": ""清空来源列表中的所有项目。"",
      ...
      ""dictionaryGeneratorContents"": {
        ""tabTitle"": ""字典"",
        ""pageTitle"": ""字典生成"",
        ""baseDirectoryLabel"": ""基础字典文件夹"",
        ""outputDirectoryLabel"": ""输出文件夹"",
        ""customSlotsLabel"": ""自定义字典槽位"",
        ""slotColumn"": ""槽位"",
        ""modeColumn"": ""模式"",
        ""dictionaryFileColumn"": ""字典文件"",
        ""dictionaryFilePlaceholder"": ""字典文件路径"",
        ""browseButton"": ""浏览"",
        ""removeButton"": ""移除"",
        ""addCustomDictionaryButton"": ""添加自定义字典"",
        ""applyCustomSlotsButton"": ""应用到当前转换器"",
        ""applyCustomSlotsDuringStartupLabel"": ""启动时应用到转换器"",
        ""generateZstdButton"": ""生成 ZSTD"",
        ""generateCborButton"": ""生成 CBOR"",
        ""generateJsonButton"": ""生成 JSON"",
        ""readableUnicodeJsonLabel"": ""可读 Unicode JSON"",
        ""baseDirectoryToolTip"": ""包含标准 OpenccNet 文本字典的文件夹。"",
        ""outputDirectoryToolTip"": ""用于保存生成字典的现有文件夹。"",
        ""browseBaseDirectoryToolTip"": ""选择基础字典文件夹。"",
        ""browseOutputDirectoryToolTip"": ""选择输出文件夹。"",
        ""slotToolTip"": ""选择要自定义的字典槽位。"",
        ""modeToolTip"": ""Append 会合并条目；Override 会替换所选槽位。"",
        ""dictionaryFileToolTip"": ""自定义字典文本文件的路径。"",
        ...
        ""readableUnicodeJsonToolTip"": ""写入可读的 Unicode 字符，而非 JSON 转义序列。"",
        ""baseDirectoryPickerTitle"": ""选择基础字典文件夹"",
        ""outputDirectoryPickerTitle"": ""选择输出文件夹"",
        ""customFilePickerTitle"": ""选择自定义字典"",
        ""dictionaryTextFilesFilter"": ""字典文本文件"",
        ""allFilesFilter"": ""所有文件"",
        ...
        ""outputDirectoryNotFoundFormat"": ""找不到输出文件夹：{0}"",
        ""unsupportedSlotFormat"": ""自定义字典第 {0} 行：不支持字典槽位 {1}。"",
        ""unsupportedModeFormat"": ""自定义字典第 {0} 行：不支持字典模式 {1}。"",
        ""rowFileRequiredFormat"": ""自定义字典第 {0} 行：必须指定文件路径。"",
        ""rowFileNotFoundFormat"": ""自定义字典第 {0} 行：找不到文件：{1}"",
        ""messageBoxTitle"": ""字典生成""
      },
      ""batchLogContents"": {
        ...
        ""autoDetectCjkEncoding"": ""Auto-detect CJK Encoding (自动检测 CJK 编码)"",
      ...
      ""runtimes"": {
        ...
        ""statuses"": {
          ""statusBtnPasteEmpty"": ""剪贴板为空"",
          ""statusBtnPastePasted"": ""已粘贴剪贴板内容"",
          ""statusBtnCopyDestinationEmpty"": ""未复制：目标内容为空。"",
          ""statusBtnCopyCopied"": ""文本已复制到剪贴板"",
          ""statusBtnCopyClipboardError"": ""剪贴板错误：{0}"",
          ""statusOpenFileError"": ""打开文件时出错：{0}"",
          ...
          ""statusDialogQuoteNormalizeEmpty"": ""没有可规范化的对话引号内容"",
          ""statusDialogQuoteDestinationNotReady"": ""目标编辑器尚未就绪"",
          ""statusDialogQuoteNormalizeComplete"": ""对话引号规范化完成"",
          ""statusDialogQuoteValidationPassed"": ""对话引号验证通过"",
          ""statusDialogQuoteValidationSuspiciousLines"": ""发现 {0} 行疑似对话引号问题"",
          ""dialogQuoteValidationTitle"": ""对话引号验证"",
          ""dialogQuoteValidationWarningTitle"": ""验证警告"",
          ""dialogQuoteValidationOkButton"": ""确定"",
          ""dialogQuoteValidationGoToFirstButton"": ""前往第一个疑似问题行"",
          ""dialogQuoteValidationCloseButton"": ""关闭"",
          ""dialogQuoteValidationNoIssues"": ""未发现疑似对话引号问题。"",
          ""dialogQuoteValidationFoundLines"": ""发现 {0} 行疑似对话引号问题。"",
          ""dialogQuoteValidationHintTitle"": ""提示："",
          ""dialogQuoteValidationHintMissingExtra"": ""实际错字通常是缺少、多余、颠倒或混用的对话引号。"",
          ""dialogQuoteValidationHintAbove"": ""可能出现在报告行或其前几行。"",
          ""dialogQuoteValidationHintFixAgain"": ""修正来源文本后再验证一次。"",
          ""dialogQuoteValidationMoreLines"": ""...以及其他 {0} 行。"",
          ...
          ""statusProcessCompleted"": ""转换完成：{0} -> {1} ms"",
          ""statusBatchNothingToConvert"": ""没有可转换的内容。"",
          ""statusBatchDone"": ""批量转换完成。（ {0} ）"",
          ""statusClearSource"": ""来源文本框已清空"",
          ""statusClearDestination"": ""目标内容已清空"",
          ""statusRemoveNothing"": ""没有可移除的项目。"",
          ""statusRemoveItem"": ""项目（{0}）{1} 已移除"",
          ""statusPreviewNothing"": ""没有可预览的内容。"",
          ""statusPreviewFile"": ""文件预览：{0}"",
          ""statusPreviewReadError"": ""文件读取错误（{0}）"",
          ""statusDetectNothing"": ""没有可检测的内容。"",
          ""statusDetectDone"": ""批量 zho code 检测完成。"",
          ""statusClearSourceList"": ""所有来源项目已清空。"",
          ""statusMessagesCleared"": ""消息已清空。"",
          ""statusPreviewCleared"": ""预览已清空。"",
