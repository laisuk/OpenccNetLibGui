  ...
  ""languages"": [
    {
      ...
      ""hints"": {
        ...
        ""autoDetectCjkEncodingHint"": ""Automatically detect legacy Big5 and GB18030-family encodings for plain-text files during batch conversion."",
    ...
    },
    {
      ...
      ""hints"": {
        ...
        ""autoDetectCjkEncodingHint"": ""批次轉換純文字檔案時，自動偵測舊式 Big5 與 GB18030 系列編碼。"",
    ...
    },
    {
      ...
      ""hints"": {
        ...
        ""autoDetectCjkEncodingHint"": ""批量转换纯文本文件时，自动检测旧式 Big5 和 GB18030 系列编码。"",
